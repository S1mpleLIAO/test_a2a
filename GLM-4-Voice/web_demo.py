...
sys.path.insert(0, "/root/test_a2a/GLM-4-Voice/cosyvoice")
sys.path.insert(0, "/root/test_a2a/GLM-4-Voice/third_party/Matcha-TTS")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--flow-path", type=str, default="/root/model/glm4-voice/glm-4-voice-decoder")
    parser.add_argument("--model-path", type=str, default="/root/model/glm4-voice/glm-4-voice-9b")
    parser.add_argument("--tokenizer-path", type= str, default="/root/model/glm4-voice/glm-4-voice-tokenizer")
